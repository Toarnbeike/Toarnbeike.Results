...
public abstract class CollectionResultExtensionTestBase
{
    ...
    protected readonly List<Result> MixedCollection = [Result.Failure(new TestFailure("code1")), Result.Success(), Result.Failure(new TestFailure("code2"))];
    ...
    protected readonly List<Task<Result>> MixedTaskCollection = [Task.FromResult(Result.Failure(new TestFailure("code1"))), Result.SuccessTask(), Task.FromResult(Result.Failure(new TestFailure("code2")))];
